...
def parse_args():
    ...
    parser.add_argument('--base_model', type=str, default='/home/yanmeng/lidong/code/CoSec2/models/codegen-11526', help='模型id或local path')
    parser.add_argument('--ref_model', type=str, default='/home/yanmeng/lidong/code/CoSec2/models/codegen-11526', help='模型id或local path')
    ...
    parser.add_argument('--output_dir', type=str, default='../trained/codegen/sec_11526_fkl_resample')

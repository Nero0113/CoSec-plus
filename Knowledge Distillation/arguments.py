...
def add_runtime_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--threshold" ,type=int, default=-1)
    group.add_argument("--not-conten-prompt", action="store_true")
...
def get_args():
    ...
    if args.type == "eval_main":
        ...
        args.save = save_path
    elif args.type == "minillm" or args.type =="distillcodercraft":

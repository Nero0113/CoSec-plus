...
for GPU_INDEX in "${!GPUS[@]}"; do
    ...
    for ((i=GPU_INDEX; i<${#VERSIONS[@]}; i+=NUM_GPUS)); do
        ...
        BASE_MODEL="/path/to/Distill/results/${MODEL_NAME}_2/train/magic/${LEARN_TYPE}/$VERSION"

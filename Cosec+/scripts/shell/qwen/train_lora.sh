...
for GPU_INDEX in "${!GPUS[@]}"; do
    ...
    for ((i=GPU_INDEX; i<${#VERSIONS[@]}; i+=NUM_GPUS)); do
        ...
        OUTPUT_DIR="../trained/${MODEL_NAME}/1.5B_learn_14B/${LEARN_TYPE}/${METHOD}/${LORA_DROPOUT}/sec_${VERSION}_refSelf_lora_${LM_RATE}_${KL_RATE}_ref_dis"

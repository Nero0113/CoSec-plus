...
for VERSION in "${VERSIONS[@]}"; do
  ...
  OUTPUT_NAME="human-eval-${MODEL_NAME}-${learn_type}-${BASE_SIZE}_learn_${TEACHER_SIZE}-${VERSION}-4.36"
  MODEL_NAME_OR_PATH="/path/to/Distill/results/${MODEL_NAME}/train/magic/${learn_type}_2/${START_VERSION}"
  # MODEL_NAME_OR_PATH="/path/to/Distill/results/starcoder/train/magic/kd_rkl_1B_lora_7B_lora_step/${VERSION}"
  # PEFT_MODEL="/path/to/Distill/results/starcoder/train/magic/kd_rkl_1B_learn_7B_1B_loralearn_13B/${VERSION}"
